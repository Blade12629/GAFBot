...
namespace ServerModule.Network
{
    public partial class Server
    {
        ...
        public void Start()
        {
            Console.WriteLine("Starting Server", LogLevel.Trace);
            _socket.Listen(10);
            ...
            Console.WriteLine("Server Started", LogLevel.Trace);
        }

        public void Dispose()
        {
            Console.WriteLine("Closing Server", LogLevel.Trace);
            _socket.Close();
        }
    }
    ...
    public partial class Server : IDisposable
    {
        ...
        private void EndRecieveClient(IAsyncResult ar)
        {
            ...
            Console.WriteLine($"New client connected {c.Host} ({c.Id})");
